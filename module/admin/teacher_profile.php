...
$query = "SELECT * FROM sms_teacher WHERE id=".$singleID."";
                        ...
                        <div class="box-body">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo $row['t_name']; ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3 " align="center"> <img alt="Photo not found" src="<?php echo 'image/teacher/'.$row['photo'] ?>" class="img-circle img-responsive" style="width:230px; height:230px;"> </div>
                                        ...
                                        <div class=" col-md-9 col-lg-9 ">
                                            <table class="table table-user-information table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Email</th>
                                                        <td><a href="mailto:info@support.com"><?php echo $row['t_email']; ?></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <a href="teacher_update.php?dd=<?php echo $row['id']?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
