...
<?php 
    $stu_query ="SELECT * FROM sms_teacher where id ='$dd'";
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <!-- Left col -->
            <section class="col-lg-10 connectedSortable" id="addteacher">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Update teacher Form</h3>
                    </div>
                    <div id="result"></div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="" method="post" id="add_teacher_form" enctype="multipart/form-data">
                        <div class="box-body">
                           <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="teacher_id" name="teacher_id" value="<?php echo $row['teacher_id']?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" id="type-select">
                                    <select class="form-control" id="responsibility" name="responsibility">
                                        ...
                                        <option value="01" <?php if($row['responsibility']=='1'){echo "selected"; }?>>Mathematics</option>
                                        <option value="02" <?php if($row['responsibility']=='2'){echo "selected"; }?>>English</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" id="type-select">
                                    <select class="form-control" id="teacher_type" name="teacher_type">
                                        <option value="0" selected>-- Select Type --</option>
                                        <option value="01" <?php if($row['teacher_type']=='1'){echo "selected"; }?>>Full Time</option>
                                        <option value="02" <?php if($row['teacher_type']=='2'){echo "selected"; }?>>Part Time</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" id="gender">
                                    <select class="form-control" id="t_gender" name="t_gender">
                                        <option value="0" selected>-- Select Type --</option>
                                        <option value="1" <?php if($row['t_gender']=='1'){echo "selected"; }?>>Male</option>
                                        <option value="2" <?php if($row['t_gender']=='2'){echo "selected"; }?>>Female</option>
                                        <option value="3" <?php if($row['t_gender']=='3'){echo "selected"; }?>>Others</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="t_phone" name="t_phone" value="<?php echo $row['t_phone']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="t_email" name="t_email" value="<?php echo $row['t_email']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="t_password" name="t_password" value="<?php echo $row['t_password']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="imageupload panel panel-default">
                                       <div><img src="image/teacher/<?php echo $row['photo']; ?>"  width="200px" alt=""/></div>
...
if(isset($_POST['update'])){
	...
	if($teacher_id == '' || $t_name =='' || $qualification=='' || $responsibility=='' || $f_name =='' || $m_name == '' || $birth_date =='' || $join_date == ''|| $teacher_type =='' || $numeric_code == ''|| $t_gender =='' || $address == ''|| $t_phone =='' || $t_email == ''|| $t_password ==''
      ){
		$msg="<div class='alert alert-danger'><strong>Error ! </strong> Field must not be empty !</div>";
        echo $msg;
		}else{
// query for insertion
$st_query = "UPDATE sms_teacher
             SET 
...
move_uploaded_file(
$_FILES['photo']['tmp_name'], "image/teacher/".$newphotoname);
