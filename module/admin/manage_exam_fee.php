 ...
 <script>
        function Deleteexamfee(id) {
            if (confirm("You want to delete this record ?")) {
                window.location.href = "exam_fee_delete.php?dd=" + id;
            }
        }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Exam Fee
            <small>Manage Exam Fee</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Exam Fee</a></li>
            <li class="active">Manage Exam Fee</li>
        </ol>
    </section>
                            ...
                            <div class="panel with-nav-tabs panel-default">
                                <div class="panel-heading">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab1default" data-toggle="tab">Exam Fee List</a></li>
                                        <li><a href="#tab2default" data-toggle="tab">Add Exam Fee</a></li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="box-body">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                       <?php
                                                        ...
                                                        $query = "SELECT * FROM sms_exam_fee";
                                                         $cal = $db->select($query);
                                                               if($cal){
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="exam_fee_update.php?dd=<?php echo $row['id']?>">Edit</a></li>
                                                        <li role="separator" class="divider"></li>
                                                        <li>
                                                            <a href="javascript:Deleteexamfee('<?php echo $row['id']; ?>')" >Delete</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                            </td>
                                       ...
                                       <?php
										...
										?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="exam_name" name="exam_name" placeholder="Exam Fee">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="exam_fee" name="exam_fee" placeholder="Exam Fee">
                                                        </div>
                                                    </div>
...
if(isset($_POST['submit'])){
    ...
    $s_sel="SELECT * FROM sms_exam_fee where sms_exam_fee= '$ex_fee' or sms_exam_name= '$ex_name' ";
...
// query for insertion
$ex_query = "insert into sms_exam_fee values ('','$cl_name','$ex_name','$ex_fee');";
