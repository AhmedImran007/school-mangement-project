...
<?php 
    $c_query ="SELECT * FROM sms_classes where id ='$dd'";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Classes
            <small>Update Classes</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">classs</a></li>
            <li class="active">Update Classes</li>
        </ol>
    </section>
                            ...
                            <div class="panel with-nav-tabs panel-default">
                                <div class="panel-heading">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#" data-toggle="tab">Class Update List</a></li>
                                            ...
                                            <form class="form-horizontal" action="" method="post">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="class-name" name="class-name" value="<?php echo $row['class_name']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="cl-numeric-code" name="cl-numeric-code" value="<?php echo $row['cl_numeric']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
