...
<?php
$query = "SELECT * FROM sms_parent";
$read = $db->select($query);
?>
    <script>
        function DeleteParent(id) {
            if (confirm("You want to delete this record ?")) {
                window.location.href = "parent_delete.php?dd=" + id;
            }
        }
                                            ...
                                            <div class="form-group">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="parent_profile.php?id=<?php echo $row['id']?>">Profile</a></li>
                                                        <li><a href="#">MarkSheet</a></li>
                                                        <li><a href="parent_update.php?dd=<?php echo $row['id']?>">Edit</a></li>
